...
public class TesterCine{
	...
	*/
	public static void main(String[] args) {
		...
		c.addSesion(s1,sal2);
		System.out.println("\nSalas(1): "+ c.getSalas());
		System.out.println("\nPeliculas(1): "+ c.getCartelera());

		c.removePeliculaCartelera(p1);
		//Comprobamos si se ha borrado la sesion tambien
		System.out.println("\nSalas(2): "+ c.getSalas());
		System.out.println("\n Peliculas(2): "+ c.getCartelera());
		...
		if(c.comprarEntrada(10,Dia.MIERCOLES, "hola", Edad.JUBILADO_R) == null){
			System.out.println("\n\tPrueba 1 venta de entradas superada");
		}

		c.addSesion(s1,sal2);
		if(c.comprarEntrada(10,Dia.MIERCOLES, "titulo", Edad.NINNO_R) == s1){
		...
		if(c.comprarEntrada(10,Dia.LUNES, "titulo", Edad.ADULTO) == s1){
			System.out.println("\n\tPrueba 2 venta de entradas superada");
		}
